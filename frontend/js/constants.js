const contractAddress = "0x31562B48066bA16B1D3f9DDd607c8b01AC145FfC"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to Roaring Hills and the TroubledTigers project";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = '8888 Tigers to prove that yes, Tigers can be stylish';
